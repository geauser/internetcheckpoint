  ...
  <div
    ...
    <div class="flex-1 max-w-4xl sm:px-10">
      ...
      <header id="js-header" class="fixed sm:relative h-14 top-0 z-50 w-full flex justify-between items-center bg-white px-4 sm:px-0">
        ...
        <a href="https://twitter.com/geauser" target="_blank" class="no-after fixed top-0 left-0 decoration-white">
          <div class="bg-stone-900 hover:bg-stone-700 text-white rounded-br-md text-xs px-2 py-1">
            <span class="text-stone-300">Made by</span> <span class="font-medium">@geauser</span>
          </div>
        </a>
    ...
    <SideNav v-if="!['/restore', '/privacy'].includes($route.path)" class="mt-6 sm:mt-14"/>
  </div>
