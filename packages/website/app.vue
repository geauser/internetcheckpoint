...
<template>
  ...
  <header id="js-header" class="fixed sm:relative top-0 z-50 w-full flex justify-end items-center bg-white max-w-4xl mx-auto px-4 sm:px-10 pb-2 sm:pb-6 pt-2 sm:pt-4">
